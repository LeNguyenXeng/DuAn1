            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        <img src="./resources/assets/img/banner-01.jpg" alt="IMG-BANNER">
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="index.php?act=productdetail&idsp=' . $id_sp . '"
                                    class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" name="tensp">
                                    ' . $tensp . '
                                </a>
