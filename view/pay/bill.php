                    ...
                    <tbody>
                        ...
                        <?php } else {
                            ...
                            foreach ($bill as $mybill) {  
                                ...
                                if ($id_trangthai === 5) {
                                    echo '<a href="'.$trahang.'" class="btn btn-outline-warning" style="margin-left: 3px;" onclick="return confirm(\'Bạn có chắc chắn muốn trả đơn hàng này không?\');">Trả Hàng</a>';
                                }
